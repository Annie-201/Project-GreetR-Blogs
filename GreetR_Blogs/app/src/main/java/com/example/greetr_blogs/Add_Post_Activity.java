                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(Add_Post_Activity.this, "Post Published Successfully", Toast.LENGTH_SHORT).show();
                                                title_blog.setText("");
                                                description_blog.setText("");
                                                blog_image.setImageURI(null);
                                                image_uri = null;

                                                startActivity(new Intent(Add_Post_Activity.this, Home_Activity.class));
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        pd.dismiss();
                                        Toast.makeText(Add_Post_Activity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
